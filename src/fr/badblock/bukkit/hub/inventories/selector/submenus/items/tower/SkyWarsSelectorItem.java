...
public class SkyWarsSelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public SkyWarsSelectorItem() {
		super("hub.items.skywarsselectoritem.8", Material.BANNER, DyeColor.LIME.getDyeData(), "hub.items.skywarsselectoritem.8.lore");
	}
