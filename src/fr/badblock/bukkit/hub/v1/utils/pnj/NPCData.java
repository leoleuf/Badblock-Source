package fr.badblock.bukkit.hub.v1.utils.pnj;
...
public class NPCData {
	...
	public void onClick(BadblockPlayer player) {
		...
		service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(HubPlayer.getRealName(player), this.getServer(), false)),
