package fr.badblock.bukkit.hub.v1.inventories.selector.animhost;

import fr.badblock.bukkit.hub.v1.inventories.abstracts.inventories.CustomInventory;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.BuildContestSelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.CTS8v8SelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.PearlsWar16SelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.Rush2v2NBSelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.SpaceBalls4v4SelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.SpeedUHCSoloSelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.SurvivalGames24SelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.Tower2v2SelectorItem;
import fr.badblock.bukkit.hub.v1.inventories.selector.animhost.items.Tower4v4SelectorItem;
