...
import fr.badblock.bukkit.hub.v1.inventories.selector.items.ShootFlagSelectorItem;
...
public class SelectorInventory extends CustomInventory {
	...
	public SelectorInventory() {
		...
		this.setItem(22, new ShootFlagSelectorItem());
		this.setItem(27, new TowerRunSelectorItem());
