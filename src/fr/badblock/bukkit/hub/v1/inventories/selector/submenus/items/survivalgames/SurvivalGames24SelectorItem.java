package fr.badblock.bukkit.hub.v1.inventories.selector.submenus.items.survivalgames;
...
public class SurvivalGames24SelectorItem extends SubGameSelectorItem {
	...
	public void onClick(BadblockPlayer player, ItemAction itemAction, Block clickedBlock) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				service.sendAsyncPacket("networkdocker.sentry.join", gson.toJson(new SEntry(HubPlayer.getRealName(player), "sg24", false)),
