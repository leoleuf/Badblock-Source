...
public class BedWars2x4SelectorItem extends SubGameSelectorItem {

	@SuppressWarnings("deprecation")
	public BedWars2x4SelectorItem() {
		super("hub.items.bedwarsselectoritem.2x4", Material.BANNER, DyeColor.LIME.getDyeData(), "hub.items.bedwarsselectoritem.2x4.lore");
	}
