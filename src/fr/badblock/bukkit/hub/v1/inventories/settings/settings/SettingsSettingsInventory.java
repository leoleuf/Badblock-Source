package fr.badblock.bukkit.hub.v1.inventories.settings.settings;

import fr.badblock.bukkit.hub.v1.inventories.abstracts.inventories.CustomInventory;
import fr.badblock.bukkit.hub.v1.inventories.settings.BackSettingsItem;
...
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.clans.CanJoinWhileRunningSettingsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.directmessages.PrivateMessagesSettingsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.friends.FriendsSettingsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.language.LanguageSettingsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.lobbychat.LobbyChatSettingsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.settings.party.PartyInviteSettingsItem;
