...
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.BuildContestStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.CTSStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.PearlsWarStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.RushStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.SpaceBallsStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.SpeedUHCStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.SurvivalGamesStatisticsItem;
import fr.badblock.bukkit.hub.v1.inventories.settings.statistics.TowerStatisticsItem;
