...
import fr.badblock.bukkit.games.badsoup.runnables.game.StartDeathmatchRunnable;
...
public class GameRunnable extends BukkitRunnable implements TimeProvider {
	...
	public void run() {
		...
		if(time == CHEST_TIME){
			...
			gen.addItemInConfiguration(new ItemStack(Material.COMPASS), PluginSoup.getInstance().getConfiguration().addedCompassProb, false);
			gen.resetChests();
