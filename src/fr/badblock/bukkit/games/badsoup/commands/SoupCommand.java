...
public class SoupCommand extends MapAbstractCommand {
	public SoupCommand(File folder) {
		super("soup", new TranslatableString("commands.survival.usage"), GamePermission.ADMIN, new String[]{"sg"}, folder);
		allowConsole(false);
	}
