...
@Getter public class BedWarsResult extends Result {
	...
	public BedWarsResult(BadblockPlayer player) {
		...
		general = registerCategory(CatNames.GENERAL.getName(), new ResultCategoryLined(
				get("bedwars.result.general.title")
				));

		teams = registerCategory(CatNames.TEAMS.getName(), new ResultCategoryArray(
				get("bedwars.result.teams.title"),
				new String[]{
						get("bedwars.result.teams.entry-players"),
						get("bedwars.result.teams.entry-bed"),
						get("bedwars.result.teams.entry-score")
				}
				));

		players = registerCategory(CatNames.PLAYERS.getName(), new ResultCategoryArray(
				get("bedwars.result.players.title"),
				new String[]{
						get("bedwars.result.players.entry-score"),
						get("bedwars.result.players.entry-kills"),
						get("bedwars.result.players.entry-deaths"),
						get("bedwars.result.players.entry-beds"),
						get("bedwars.result.players.entry-rank"),
						get("bedwars.result.players.entry-kit")
				}
				));
	}
